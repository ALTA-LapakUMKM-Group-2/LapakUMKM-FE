...
const CartCard: React.FC<CartProps> = ({
    ...
    return (
        <div id={id} className="grid gap-y-3 items-center bg-white border-y-2 border-gray-200 rounded-lg  p-4 md:flex-row md:max-w-xl">
            <div className="flex space-x-5">
                                ...
                                <div className="flex flex-row">
                                    ...
                                    <div className="flex flex-col p-4 leading-normal w-60">
                                        ...
                                        <p className="font-semibold text-gray-700 ">{formatValue({
                                            value: JSON.stringify(price),
                                            groupSeparator: '.',
                                            decimalSeparator: ',',
                                            prefix: 'Rp. ',
                                        })}</p>
                                        <p className="font-semibold text-gray-700 ">{"Total : "} {count > 1 ? formatValue({
